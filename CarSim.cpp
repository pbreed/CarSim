...
/////////////////////////////////////////////////////////////////////////////
// The one and only CCarSimApp object
...
BOOL CCarSimApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCarSimDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CCarSimView));
